...
# MAGIC %pip install "git+https://github.com/burning-cost/insurance-fairness.git" catboost polars scikit-learn scipy jinja2 pyarrow statsmodels networkx POT pytest

# COMMAND ----------

import subprocess, sys, os, tempfile, re

work_dir = tempfile.mkdtemp(prefix="insurance_fairness_indirect_")
...
result = subprocess.run(
    [sys.executable, "-m", "pytest",
     os.path.join(work_dir, "tests", "test_indirect.py"),
     "-v", "--tb=short"],
